...
package ModeloGui;
import Controles.ControladorUsuario;
 ...
 * @author HP
 */
public class ModelTablaUsuario extends AbstractTableModel{
    ArrayList<Usuarios> usuarios = new ArrayList<Usuarios>();
    ControladorUsuario cu = new ControladorUsuario();
    String[] titulos = new String[24];

    public ModelTablaUsuario() {
        ...
        titulos[23] ="AcercaDe";
        try {
            usuarios = (ArrayList<Usuarios>)cu.getRegistros();
        } catch (Exception ex) {
    ...
    public Usuarios getFila(int index)
    {
