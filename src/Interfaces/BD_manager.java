...
public class BD_manager {
    ...
    public void AbcProye(String Consulta) throws Exception
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "ERROR DE ACTUALIZACION", "REVISELO", JOptionPane.INFORMATION_MESSAGE);            
            ex.printStackTrace();
        }
            conn.close();
            St.close();
    ...
    public String BuscaEva(String sQl) throws Exception
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "NO EXISTE INFORMACION", "REVISELO", JOptionPane.INFORMATION_MESSAGE);
        }
        return x;
    }
