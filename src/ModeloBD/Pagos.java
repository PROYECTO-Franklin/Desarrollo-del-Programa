...
public class Pagos extends ModeloGeneric{
    ...
    public Pagos(Integer civFolio, Integer norCuenta, String fechaCubierta, Integer mesesTranscurridos, String fechaPago, Float rezago, Float pagoCalculado, Float recargo, Float total, Date fechaRegistro, Cliente cliente) {
    ...
    public Pagos(Integer norCuenta, String fechaCubierta, Integer mesesTranscurridos, String fechaPago, Float rezago, Float pagoCalculado, Float recargo, Float total, Date fechaRegistro, Cliente cliente) {
        this.norCuenta = norCuenta;
        this.fechaCubierta = fechaCubierta;
        this.mesesTranscurridos = mesesTranscurridos;
        this.fechaPago = fechaPago;
